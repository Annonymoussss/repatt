...
public class ManualLocator extends AbstractFaultlocalization {
  ...
  private final Map<String, Pair<String, Integer>> _faultLocMap = new HashMap<>();
  private final Map<String, String> _failedTestMap = new HashMap<>();
  ...
  private void init() {
    ...
    _faultLocMap.put(
        "chart_2", new Pair<String, Integer>("org.jfree.data.general.DatasetUtilities", 752));
    _failedTestMap.put(
        "chart_2", "org.jfree.data.general.junit.DatasetUtilitiesTests::testBug2849731_2");
    ...
    _faultLocMap.put(
        "chart_7", new Pair<String, Integer>("org.jfree.data.time.TimePeriodValues", 299));
    _failedTestMap.put(
        "chart_7", "org.jfree.data.time.junit.TimePeriodValuesTests::testGetMaxMiddleIndex");

    _faultLocMap.put(
        "chart_11", new Pair<String, Integer>("org.jfree.chart.util.ShapeUtilities", 275));
    _failedTestMap.put(
        "chart_11", "org.jfree.chart.util.junit.ShapeUtilitiesTests::testEqualGeneralPaths");

    _faultLocMap.put(
        "chart_12", new Pair<String, Integer>("org.jfree.chart.plot.MultiplePiePlot", 145));
    _failedTestMap.put(
        "chart_12", "org.jfree.chart.plot.junit.MultiplePiePlotTests::testConstructor");
    ...
    _failedTestMap.put(
        "closure_14", "com.google.javascript.jscomp.CheckMissingReturnTest::testIssue779");

    _faultLocMap.put(
        "closure_57",
        new Pair<String, Integer>("com.google.javascript.jscomp.ClosureCodingConvention", 197));
    _failedTestMap.put(
        "closure_57", "com.google.javascript.jscomp.ClosureCodingConventionTest::testRequire");

    _faultLocMap.put(
        "closure_73",
        new Pair<String, Integer>("com.google.javascript.jscomp.CodeGenerator", 1045));
    _failedTestMap.put("closure_73", "com.google.javascript.jscomp.CodePrinterTest::testUnicode");

    _faultLocMap.put(
        "closure_77", new Pair<String, Integer>("com.google.javascript.jscomp.CodeGenerator", 966));
    ...
    /*--------------------------------LANG----------------------------------------*/
    _faultLocMap.put(
        "lang_16", new Pair<String, Integer>("org.apache.commons.lang3.math.NumberUtils", 458));
    _failedTestMap.put(
        "lang_16", "org.apache.commons.lang3.math.NumberUtilsTest::testCreateNumber");

    _faultLocMap.put(
        "lang_33", new Pair<String, Integer>("org.apache.commons.lang3.ClassUtils", 909));
    ...
    _faultLocMap.put(
        "lang_35", new Pair<String, Integer>("org.apache.commons.lang3.ArrayUtils", 3292));
    // second one : triggered by
    // String[] sa = ArrayUtils.add(stringArray, 0, aString);
    //		_faultLocMap.put("lang_35", new Pair<String, Integer>("org.apache.commons.lang3.ArrayUtils",
    // 3575));
    _failedTestMap.put("lang_35", "org.apache.commons.lang3.ArrayUtilsAddTest::testLANG571");

    _faultLocMap.put(
        "lang_39", new Pair<String, Integer>("org.apache.commons.lang3.StringUtils", 3675));
    _failedTestMap.put(
        "lang_39",
    ...
    _faultLocMap.put(
        "lang_58", new Pair<String, Integer>("org.apache.commons.lang.math.NumberUtils", 452));
    _failedTestMap.put("lang_58", "org.apache.commons.lang.math.NumberUtilsTest::testLang300");

    _faultLocMap.put(
        "lang_59", new Pair<String, Integer>("org.apache.commons.lang.text.StrBuilder", 884));
    _failedTestMap.put(
        "lang_59", "org.apache.commons.lang.text.StrBuilderAppendInsertTest::testLang299");

    // need to split test case
    // first one: triggered by
    // assertFalse( "The contains(char) method is looking beyond the end of the string",
    // sb.contains('h'));
    _faultLocMap.put(
        "lang_60", new Pair<String, Integer>("org.apache.commons.lang.text.StrBuilder", 1673));
    // second one: triggered by
    // assertEquals( "The indexOf(char) method is looking beyond the end of the string", -1,
    // sb.indexOf('h'));
    ...
    /*--------------------------------MATH----------------------------------------*/
    _faultLocMap.put(
        "math_5", new Pair<String, Integer>("org.apache.commons.math3.complex.Complex", 304));
    _failedTestMap.put(
        "math_5", "org.apache.commons.math3.complex.ComplexTest::testReciprocalZero");
    ...
    _failedTestMap.put(
        "math_33", "org.apache.commons.math3.optimization.linear.SimplexSolverTest::testMath781");
    ...
    // first one: for
    // [org.apache.commons.math.linear.SparseRealVectorTest::testConcurrentModification && w =
    // u.ebeDivide(v1);]
    _faultLocMap.put(
        "math_49",
        new Pair<String, Integer>("org.apache.commons.math.linear.OpenMapRealVector", 345));
    //		// second one: for
    // [org.apache.commons.math.linear.SparseRealVectorTest::testConcurrentModification && w =
    // u.ebeDivide(v2);]
    ...
    _faultLocMap.put(
        "math_53", new Pair<String, Integer>("org.apache.commons.math.complex.Complex", 153));
    _failedTestMap.put("math_53", "org.apache.commons.math.complex.ComplexTest::testAddNaN");

    _faultLocMap.put(
        "math_59", new Pair<String, Integer>("org.apache.commons.math.util.FastMath", 3482));
    _failedTestMap.put("math_59", "org.apache.commons.math.util.FastMathTest::testMinMaxFloat");

    _faultLocMap.put(
        "math_63", new Pair<String, Integer>("org.apache.commons.math.util.MathUtils", 417));
    ...
    _failedTestMap.put(
        "math_70", "org.apache.commons.math.analysis.solvers.BisectionSolverTest::testMath369");
    ...
    _faultLocMap.put(
        "math_71",
        new Pair<String, Integer>(
            "org.apache.commons.math.ode.nonstiff.EmbeddedRungeKuttaIntegrator", 294));
    _failedTestMap.put(
        "math_71",
        "org.apache.commons.math.ode.nonstiff.DormandPrince853IntegratorTest::testMissedEndEvent");
    ...
    _failedTestMap.put(
        "math_72", "org.apache.commons.math.analysis.solvers.BrentSolverTest::testRootEndpoints");

    _faultLocMap.put(
        "math_75", new Pair<String, Integer>("org.apache.commons.math.stat.Frequency", 303));
    _failedTestMap.put("math_75", "org.apache.commons.math.stat.FrequencyTest::testPcts");

    _faultLocMap.put(
        "math_79", new Pair<String, Integer>("org.apache.commons.math.util.MathUtils", 1624));
    _failedTestMap.put(
        "math_79",
    ...
    _faultLocMap.put(
        "math_98", new Pair<String, Integer>("org.apache.commons.math.linear.BigMatrixImpl", 991));
