...
public class CmdFactory {
  ...
  public static String[] createTestSingleTestCaseCmd(
      Subject subject, int timeout, String clazzAndMethod) {
    return createD4JCmd(subject, "test -t " + clazzAndMethod, timeout);
  }

  public static String[] createTestSingleTestCaseCmd(
      Subject subject, int timeout, String clazz, String method) {
