...
public class Runner {
  ...
  private static final String __name__ = "@Runner ";
  private static final String SUCCESSTEST = "Failing tests: 0";
  ...
  public static boolean testSingleTest(Subject subject, String clazzAndMethod) {
    ...
    try {
      ...
      message =
          Executor.execute(CmdFactory.createTestSingleTestCaseCmd(subject, 30, clazzAndMethod));
    } catch (Exception e) {
