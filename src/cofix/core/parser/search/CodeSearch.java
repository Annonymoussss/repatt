...
public class CodeSearch {
    ...
    private final int MAX_MORE_THRESHOLD = 5;
    ...
    public CodeSearch(
            CompilationUnit unit, int extendedLine, int lineRange, Statement extendedStatement) {
    ...
    public Statement getExtendedStatement() {
        return _extendedStatement;
    }
...
//            }
    ...
    private List<ASTNode> extend(ASTNode node) {
        ...
        if (selfIndex != -1) {
            ...
            if ((_currentLines - _lineRange) < MAX_MORE_THRESHOLD
                    && _lineRange - _currentLines > MAX_LESS_THRESHOLD
