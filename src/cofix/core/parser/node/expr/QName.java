...
public class QName extends Label {
  ...
  public boolean match(
    ...
    if (node instanceof QName) {
      ...
      if (_exprType.toString().equals(qName._exprType.toString())
          || NodeUtils.isWidenType(_exprType, qName._exprType)) {
        match = true;
      ...
      if (srcType.equals("?")
          || tarType.equals("?")
          || srcType.equals(tarType)
          || NodeUtils.isWidenType(_exprType, sName._exprType)) {
        match = true;
        ...
        if (mapvar != null) {
          String typeStr =
              allUsableVariables.get(mapvar) == null
                  ? "?"
                  : allUsableVariables.get(mapvar).toString();
          if (_exprType.toString().equals(typeStr)
              || NodeUtils.isWidenType(_exprType, allUsableVariables.get(mapvar))) {
            match = true;
