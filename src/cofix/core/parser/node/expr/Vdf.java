...
public class Vdf extends Node {
  ...
  private final Expr _expression_replace = null;
    ...
    if (node instanceof Vdf) {
      ...
      if (_expression != null && other._expression != null) {
        if (_expression instanceof NumLiteral && other._expression instanceof NumLiteral) {
          match = true;
          if (NodeUtils.isBoundaryValue((NumLiteral) _expression)
              && NodeUtils.isBoundaryValue((NumLiteral) other._expression)) {
            return match;
          }
        }
  ...
  public List<SVariable> getVariables() {
    List<SVariable> list = _identifier.getVariables();
    if (_expression != null) {
