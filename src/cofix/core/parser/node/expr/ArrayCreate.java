...
public class ArrayCreate extends Expr {
  ...
  /**
   * ArrayCreation: new PrimitiveType [ Expression ] { [ Expression ] } { [ ] } new TypeName [ <
   * Type { , Type } > ] [ Expression ] { [ Expression ] } { [ ] } new PrimitiveType [ ] { [ ] }
   * ArrayInitializer new TypeName [ < Type { , Type } > ] [ ] { [ ] } ArrayInitializer
   */
      ...
      if (_dimension != null && other._dimension != null) {
        ...
        modifications.addAll(
            NodeUtils.listNodeMatching(
                this, _nodeType, _dimension, other._dimension, varTrans, allUsableVariables));
      }
    } else {
